...
public class ColliderForAssaultRifleMagazine : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "AssaultRifleMagazine" && AssaultRifleParams.isEmptyMagazine == true)
        {
            if (other.GetComponent<AssaultRifleMagazine>().mode == 2)
            {
               ...
               // other.transform.localScale = temp.localScale;
                ...
                other.GetComponent<AssaultRifleMagazine>().mode = 1;
                AssaultRifleParams.isEmptyMagazine = false;
