...
public class ColliderForSmgMagazine : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "SmgMagazine" && SmgParams.isEmptyMagazine == true)
        {
            if (other.GetComponent<SmgMagazine>().mode == 2)
            {
                ...
                other.GetComponent<SmgMagazine>().mode = 1;
                SmgParams.isEmptyMagazine = false;
